...
public class C03_findelements {
    public static void main(String[] args) {
        ...
        */
        ...
        //Shop degals in Electronics webElementinin yazısını yazdıralım
        System.out.println(driver.findElement(By.linkText("Shop deals in Electronics")).getText()); //Shop deals in Electronics
        driver.close();
